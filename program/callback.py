...
async def cbguides(_, query: CallbackQuery):
    await query.edit_message_text(
          f""" ♨️الدليل الأساسي لاستخدام هذا البوت:♨️

 1 ↤♨️ أولاً ، أضفني إلى مجموعتك ♨️

 2 ↤♨️ بعد ذلك ، قم بترقيتي كمشرف ومنح جميع الصلاحيات باستثناء الوضع الخفي ♨️

 3 ↤♨️ بعد ترقيتي ، اكتب .تحديث في المجموعة لتحديث بيانات المشرفين ♨️

 3 ↤♨️ أضف @B_I_7 إلى مجموعتك أو اكتب .استدعاء لدعوة حساب المساعد ♨️

 4 ↤♨️ قم بتشغيل المكالمة  أولاً قبل البدء في تشغيل الفيديو / الموسيقى ♨️

 5 ↤♨️ في بعض الأحيان، يمكن تساعدك إعاده تحميل البوت باستخدام الأمر  .تحديث في إصلاح بعض المشكلات ♨️

 ♨️ إذا لم ينضم البوت إلى المكالمة ، فتأكد من تشغيل المكالمة  بالفعل ، أو اكتب .غادر ثم اكتب .استدعاء مرة أخرى ♨️

 💡 إذا كانت لديك أسئلة  حول هذا البوت ، فيمكنك إخبارنا منن خلال قروب الدعم الخاصة بي هنا ↤ @V_8_T ♨️
...
»  .شغل »「اسم الأغنية / رابط」تشغيل الصوت mp3 في المكالمة
 ...
 » .تشغيل فيديو »「اسم / رابط الفيديو」 تشغيل الفيديو داخل المكالمه 

» .تشغيل صوت »「رابط 」تشغيل صوت

 » .اشتغل مباشر +「رابط」» تشغيل فيديو مباشر من اليوتيوب
